...
void generarCuentaNormal(FILE *usuarios) {
    ...
    // Decido el tipo de usuario para contrasenia
    struct normalAccount.typeAccount = 1;
...
void generarCuentaEntrenador(FILE *entrenadores){
    ...
    struct entrenadorAccount.typeAccount = 2;
...
void generarCuentaEnArchivoUsuario(FILE *usuarios, user userWrite){
        generacionCuentas(1);
...
void generarCuentaEnArchivoEntrenadores(FILE *entrenadores, user userWrite){
        generacionCuentas(2);
